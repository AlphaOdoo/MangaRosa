# -*- coding: utf-8 -*-
{
    ...
    "description": """
        ...
        0.0.0.5 Corrección ir.medel.access
        0.0.0.6 adicion de metodo para importar desde excel para una orden de compra
                adicion de funcionalidad de creaaaaar productos nuevos en base a un excel 
