...
class OrdenCompra(models.Model):
    ...
    nro_order = fields.Char(string='Número de Orden de Compra', required=False)
    ...
    def _onchange_partner(self):
        # Obtiene Secuncia con respecto a la bd
        if(self.requested_type_ncr == 'NCR equipos'):
            ...
            orders = self.env['purchase.order'].search([('requested_type_ncr', '=', 'otros'),('nro_order', 'not like', '7115'),('nro_order', 'not like', 'OC'),('nro_order', 'not like', 'OI')], order='nro_order desc',limit=1,)
        ...
        sequence = int(num)
        #self.nro_order = num
        # Obtiene Codigo prefijo segun proveedor
        if self.requested_type_ncr == 'NCR equipos':
            initvalue = sequence
